...
This file documents the crates directory structure and identifies accessible source files for logic improvements, excluding protected files (soul core, identity, Cargo files).
...
### **tempo-x402-gateway**
- **Description**: Gateway/Facilitator implementation.
- **Modifiable Source Files**:
  ...
  - `crates/tempo-x402-gateway/src/routes/endpoints.md`
...
### **tempo-x402-soul**
- **Description**: The autonomous agent core logic.
- **Modifiable Source Files**:
...
- **Description**: Common utilities and protocol implementation.
- **Modifiable Source Files**:
...
### **tempo-x402-app**
- **Description**: Frontend application (Yew/Leptos).
- **Modifiable Source Files**:
...
### **tempo-x402-identity**
- **Description**: Identity-related logic.
- **Protected Source Files**: All files in this crate are considered identity-related and are excluded from logic improvements.

### **Excluded Files**
- `Cargo.toml`, `Cargo.lock`
- Any identity-related files (all in `tempo-x402-identity`)
- Protected files (soul core - though parts of `tempo-x402-soul` are listed above, some core mechanisms are protected).
